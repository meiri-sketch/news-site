...
2. כתוב כותרת לכל קטגוריה בשורה נפרדת מודגשת עם * משני הצדדים + הכותרת ב BOLD מודגש 
...
8.  אל תוסיף שמות, תפקידים, או פרטים שלא כתובים במפורש בטקסט המקורי. אם שם לא מופיע- אל תמציא אותו
